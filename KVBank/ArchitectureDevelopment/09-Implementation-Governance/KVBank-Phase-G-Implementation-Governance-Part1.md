...
│  ├─────────────────────────────────────────────────────────────────────────┤   │
│  │  WP-03: Data Platform                                                    │   │
│  │  • Foundation for all data services                                      │   │
...
│  ════════════════════════════════════════════════                                │
│  ┌─────────────────────────────────────────────────────────────────────────┐   │
│  │  WP-02: Core Banking (M4)      │  WP-11: Security (M1)                  │   │
│  │  WP-04: Digital Channels (M7)  │  WP-12: DR & Resilience (M10)          │   │
│  │  WP-05: Payments (M7)          │  WP-06: Risk & Compliance (M10)        │   │
...
### 3.1.1 WP-01: Platform Foundation
...
### 3.1.2 WP-02: Core Banking Decomposition
...
### 3.1.5 WP-05: Payment Modernization
